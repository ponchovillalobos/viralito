...
const STYLES: { id: StyleId; name: string; tagline: string; emoji: string; recommended?: boolean }[] = [
  ...
  { id: "motion_pro", name: "Motion Pro", tagline: "Animación LIMPIA al ritmo real de la música: cortes al beat, palabras clave gigantes y gráficas. Sin emojis.", emoji: "✨" },
  { id: "motion_beat", name: "Motion Beat", tagline: "Todo al ritmo: la música entra en su parte fuerte, zooms al beat y destello de luz en el golpe.", emoji: "🎧" },
  { id: "motion_grid", name: "Motion Grid", tagline: "Look retro-tech futurista: cuadrícula en perspectiva + gráficas, cortes al ritmo. Sin emojis.", emoji: "🌐" },
  ...
  { id: "kinetic_type", name: "Tipografía cinética", tagline: "Palabras clave gigantes cuando se dicen + subtítulos palabra por palabra al ritmo. Sin emojis.", emoji: "⌨️" },
