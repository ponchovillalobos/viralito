...
|---|---|---|---|---|---|---|---|---|---|
| r | Sin textos repetidos | # de repeticiones en pantalla (overlay ≈ subtítulo hablado, overlays solapados, títulos duplicados) | **`python/check_text_overlap.py`** (Jaccard de tokens vs subtítulo, sim≥0.6) | **31 repeticiones / 19 de 30 clips** *(medido)* — patrón: editorial `card.title` ≈ subtítulo (hasta 1.00) | ≤10 | ≤3 | **0** | 8 | 4/5/9 |
